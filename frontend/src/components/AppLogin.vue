      ...
      <div v-else>
        <v-btn-group color="#00B4E7" density="comfortable" rounded="lg" divided>
          <v-btn variant="flat" @click="dialog = true">
            <div class="text-none font-weight-regular">SE CONNECTER</div>
          </v-btn>
        </v-btn-group>
      </div>
    </div>
    ...
    <v-dialog v-model="dialog" max-width="500" class="rounded-xl">
      <v-card rounded="xl" color="#1A75BB">
        ...
        <v-card-text class="text-center">
          <div class="text-white font-weight-bold text-h5">Bienvenue</div>
          <div class="text-white mb-4">Connectez-vous ou créez un compte</div>
          ...
          <div class="text-medium-emphasis mb-1 text-body-2">
            En cliquant sur se connecter, vous acceptez nos conditions
