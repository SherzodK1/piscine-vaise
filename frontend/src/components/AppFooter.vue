<template>
  <v-footer class="d-flex flex-column" color="#24292D">
    <v-container>
      <v-row>
        <v-col>
        ...
        <v-col class="d-flex justify-end align-center">
          <div>
            <h5 class="mb-3 text-h5 font-wheight-bold">SUIVEZ-NOUS</h5>
            <div class="d-flex">
      ...
      <v-row>
        <v-col>
          <div class="d-flex flex-row justify-center gc-10">
            <p>Copyright 2024 Spider Web Tech.</p>
            <p>
              Tél:
              <a href="tel:+33472531181" style="color: #efefef"
                >+33 4 72 53 11 81</a
              >
            </p>
            <div class="d-flex gc-10">
              <a href="/contact" style="color: #efefef">Contactez-nous</a>
              <a href="/apropos" style="color: #efefef"
                >À propos du Centre sportif</a
              >
              <a href="/credit" style="color: #efefef"
                >Politique de confidentialité</a
              >
            </div>
            <p style="color: #efefef">
              50 avenue Sidoine Apollinaire, 69009 Lyon France
            </p>
          </div>
        </v-col>
      </v-row>
