<template>
  ...
  <div class="bg-grey-darken-4">
    <!-- Section Hero -->
    <v-img
      src="https://i.goopics.net/3qmntv.jpg"
      max-height="600px"
      cover
    ...
    <!-- Section Cours -->
    <v-container fluid class="my-14 bg-blue-darken-4 py-8">
      ...
      <v-row v-if="cours && cours.length > 0">
        ...
        >
          <v-card class="text-center rounded-lg" outlined>
            ...
            <v-btn class="mb-4" @click="openDialog(cour)" color="primary">
              Détails
            </v-btn>
          </v-card>
        </v-col>
      ...
      <v-dialog v-model="dialog" max-width="500">
        <v-card>
          <v-img :src="selectedCour.image" height="250" cover></v-img>
